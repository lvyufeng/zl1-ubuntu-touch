...
always "      scripts/host/zl1-one-boot-runbook-selftest.sh, 90 checks, whose five callees are recording"
...
always "      about what ran and produced ZERO failures until the subject grew that check."
...
always "      scripts/host/zl1-lpm-ladder-trial-selftest.sh, 124 checks, whose safety model is a WHITELIST"
