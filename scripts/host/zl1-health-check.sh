...
always "   125 checks. It sweeps every script THIS page names (42 of them -- 37 the page spells out as a"
...
always "   in two shapes for that reason -- the path it spells out (29) and the bare basename it names (5)"
