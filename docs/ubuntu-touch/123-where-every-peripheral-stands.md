...
* **不声称"硬件都驱动了"。**表里 14 项：**5 项已证明**、**4 项部分**、**1 项不存在**、
  **3 项只量过离线**、**1 项（发热）三个修复都装上了，③的效果量出来了，②跑过三次而三次印出来的都不是价钱**，而**②的仪器现在多了一个交替配对的设计**（docs 175，未上设备）（2026-09-25 更新；docs 164/166/167/170/172/173/174）。
