...
always "   95 checks. Five mutations each change what it observes (the settle removed, the verdict gate"
always "        widened to a substring, the licence flag dropped from the kill, the preflight turned back"
always "        into an existence test, the EDL refusal deleted), and writing it caught two checks that"
