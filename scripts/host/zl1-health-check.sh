...
always "      (cpuidle/state*/disable, thermal_zone*/mode and policy) -- it reads them and changes none."
...
always "      lpm_levels.sleep_disabled=1, a knob the kernel's own __setup table accepts (checked in the"
always "      decompressed boot kernel, beside lpm_levels.menu_select and cpuidle.off). A SoC told not to"
...
always "      scripts/host/zl1-sleep-and-throttle-selftest.sh, 88 checks. Writing it found a real defect in"
