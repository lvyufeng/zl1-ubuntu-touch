...
always "   124 checks. It sweeps every script THIS page names (42 of them -- 37 the page spells out as a"
...
always "      scripts/host/zl1-one-boot-runbook-selftest.sh, 95 checks, whose five callees are recording"
...
always "      cannot show that the reading works on the shape the device has."
