...
always "   98 checks. It sweeps every script THIS page names (30 of them -- 25 the page spells out as a"
...
always "   in two shapes for that reason -- the path it spells out (25) and the bare basename it names (5)"
