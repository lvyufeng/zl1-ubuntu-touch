...
always "      offline: scripts/host/zl1-loc-fp-selftest.sh, 195 checks. It has found four real defects in"
...
always "      which asked \`nsenter -m -- test\` and so always answered 'missing' on the device. Plus four"
