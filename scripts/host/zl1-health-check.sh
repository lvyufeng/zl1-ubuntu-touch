...
always "   129 checks. It sweeps every script THIS page names (44 of them -- 39 the page spells out as a"
...
always "      scripts/host/zl1-one-boot-runbook-selftest.sh, 118 checks, whose five callees are recording"
