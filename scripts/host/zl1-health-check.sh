...
always "   107 checks. Seven mutations each change what it observes (the settle removed, the verdict gate"
always "        widened to a substring, the licence flag dropped from the kill, the preflight turned back"
always "        into an existence test, the EDL refusal deleted, the governor gated on the proof again, and"
always "        the kill made unconditional), and writing it caught two checks that"
...
always "        and a mutation that edited the header PROSE instead of the invocation.)"
