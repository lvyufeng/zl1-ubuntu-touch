...
always "   102 checks. It sweeps every script THIS page names (32 of them -- 27 the page spells out as a"
...
always "   in two shapes for that reason -- the path it spells out (27) and the bare basename it names (5)"
