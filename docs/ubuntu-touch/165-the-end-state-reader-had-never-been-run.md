...
所以下一次开机该做的是一次**三个成因都在**的 A/B/C —— **[`166`](166-what-the-third-cause-is-worth-in-degrees.md)
把这一句落成了一个仪器，并且把设计从两个窗口改成三个**：这台机器一小时自己就能漂 5.3 °C，
两个窗口量到的差值里，阶梯的贡献和"手机在自己变热"分不开。再往后是硬件清单上还没有驱动起来的那几项。
