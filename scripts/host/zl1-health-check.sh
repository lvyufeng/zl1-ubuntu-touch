...
always "      offline: scripts/host/zl1-loc-fp-selftest.sh, 124 checks. It has found three real defects:"
...
always "      Section 2 now reads biometryd's OWN getprop and says AGREE/DISAGREE against the device's"
