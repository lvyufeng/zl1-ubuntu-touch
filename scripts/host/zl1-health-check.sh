...
always "   118 checks. It sweeps every script THIS page names (40 of them -- 35 the page spells out as a"
...
always "   scripts/host/zl1-post-recovery-capture-selftest.sh, 139 checks, and five mutations each"
