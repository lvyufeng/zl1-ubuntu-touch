...
always "   110 checks. It sweeps every script THIS page names (36 of them -- 31 the page spells out as a"
...
always "   375 checks. It covers the four installers that write device state and had no harness, of which"
